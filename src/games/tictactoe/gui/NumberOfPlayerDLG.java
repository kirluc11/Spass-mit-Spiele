...
public class NumberOfPlayerDLG extends javax.swing.JDialog {
    ...
    private void onMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onMouseClicked
        if (((JLabel) evt.getSource()).getText().equals(lbSingle.getText())) {
            ...
            if (((JLabel) evt.getSource()).getText().equals(lbMult.getText())) {
                ok = true;
                singlePlayer = false;
                dispose();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumberOfPlayerDLG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NumberOfPlayerDLG dialog = new NumberOfPlayerDLG(new javax.swing.JFrame(), true);
